...
|---|---|---|
| Python behavior | `uv run pytest -q` passed locally; the current receipt records 146 collected tests | Clinical validity, external performance, or reviewer approval |
