...
The current checkout collects 176 Python tests and 28 Node Pages/parser tests.
...
|---|---|---|---|---|---|
| E-001 | Canonical feature matrix contains exactly 35 variables and preserves the named categories | Codex | automated test and source inspection | `uv run pytest`: 176 tests passed; `FEATURE_NAMES` contains 35 unique entries and the model matrix contains 36 columns (35 inputs plus FI) | passing |
